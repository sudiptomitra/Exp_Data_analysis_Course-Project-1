...
par(mfrow=c(2,2))
with(plot_data,plot(dateTime,Global_active_power,xlab = "", ylab ="Global Active Power",type = "l"))
with(plot_data,plot(dateTime,Voltage,xlab = "", ylab ="Voltage",type = "l"))
...
with(plot_data,plot(dateTime,Global_reactive_power,xlab = "datetime", ylab ="Global_reactive_power",type = "l"))
dev.off()
